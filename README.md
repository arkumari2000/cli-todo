...
Here's how it is working when you're done:
...
2. The code is written in the `todo.js` file.

3. Once you are done with the settings you should be able to execute the todo app by running the following command from the terminal.
